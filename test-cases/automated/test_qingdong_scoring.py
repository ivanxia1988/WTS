...
SCRIPT = Path(__file__).resolve().parents[2] / 'collaborators/qingdong/source/scripts/decision_basis.py'
spec = importlib.util.spec_from_file_location('qingdong_decision_basis', SCRIPT)
